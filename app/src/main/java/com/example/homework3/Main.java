        ...
        view.findViewById(R.id.buttonWeightSet).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.containerView,new SetGender(),"SetGenderFragment")
                        .addToBackStack(null)
                        .commit();
       ...
       view.findViewById(R.id.addDrinks).setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               if (user == null){
                ...
                getActivity().getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.containerView,new AddDrink(),"AddDrinkFragment")
                        .addToBackStack(null)
                        .commit();
//
               }
       ...
       view.findViewById(R.id.viewDrinks).setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               if (drinks.isEmpty()){
                 ...
                 getActivity().getSupportFragmentManager()
                         .beginTransaction()
                         .replace(R.id.containerView, ViewDrink.newInstance(drinks),"ViewDrinkFragment")
                         .addToBackStack(null)
                         .commit();
               }
           }
